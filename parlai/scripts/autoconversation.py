...
from parlai.agents.local_human.local_human import LocalHumanAgent, AutoQueryAgent
...
def setup_args(parser=None):
    ...
    parser.add_argument(
        ...
        type='bool',
        default=False,
        help='Saves a jsonl file containing all of the task examples and model replies. Must also specify --report-filename'
    )
    parser.add_argument(
        '--report_filename',
        type=str,
        default='custom_conversations/sample'
    )
    parser.add_argument(
        "--log-keep-fields",
        type=str,
...
#    human_agent = LocalHumanAgent(opt)
    human_agent = AutoQueryAgent(opt, query_txt=opt['report_filename']+".txt")
