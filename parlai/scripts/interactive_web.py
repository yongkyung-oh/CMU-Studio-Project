    ...
    <body>
        ...
        <script>
            function createChatRow(agent, text, stamp) {{
                ...
                if (agent == "You") {{
                    // Make magic word underline 
                    if (paraText.data.includes("GOOGLE")) {{
                        var paraText = document.createElement("a");
                        paraText.innerHTML += "<u> "+text+" </u>" ;
                    }};
                }} else if (agent == "Model") {{
                    // Make search link text to href 
                    if (paraText.data.includes("https://www.google.com")) {{
                        var paraText = document.createElement("a");
                        paraText.innerHTML += "<a href='"+text+"'> <u> Here is the <b> search link. </b> </u> </a>";
                    }};
                }};
            ...
            document.getElementById("interact").addEventListener("submit", function(event){{
                ...
                fetch('/interact', {{
                    ...
                    parDiv.append(createChatRow("Model", data.text, stamp_out));
